    ...
    entity AggregatedCommercialMeasures    as
        projection on db.CommercialMeasures {
            ...
            key toMetric.toService.interval,
                ...
                currency,
                count(
                    toMetric.toService.serviceId
                ) as countServices                   : Integer,
                STRING_AGG(
    ...
    entity CommercialMeasuresForYears      as
        select
            ...
            key AccountStructureItem_ID,
                ...
                max(
                    (reportMonth = 1 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_01          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 2 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_02          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 3 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_03          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 4 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_04          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 5 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_05          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 6 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_06          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 7 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_07          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 8 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_08          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 9 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_09          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 10 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_10          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 11 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_11          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 12 ? Measures_measure_cost : null)
                )                      as Measures_measure_cost_12          : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 1 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_01    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 2 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_02    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 3 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_03    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 4 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_04    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 5 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_05    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 6 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_06    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 7 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_07    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 8 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_08    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 9 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_09    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 10 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_10    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 11 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_11    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 12 ? Measures_delta_measure_cost : null)
                )                      as Measures_delta_measure_cost_12    : Decimal(20, 2) @(Measures.ISOCurrency: Measures_currency),
                max(
                    (reportMonth = 1 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_01 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 2 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_02 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 3 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_03 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 4 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_04 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 5 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_05 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 6 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_06 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 7 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_07 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 8 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_08 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 9 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_09 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 10 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_10 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 11 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_11 : Integer        @(Measures.Unit: '%'),
                max(
                    (reportMonth = 12 ? Measures_delta_measure_costPct : null)
                )                      as Measures_delta_measure_costPct_12 : Integer        @(Measures.Unit: '%')
        from CommercialMeasures
        where
            interval = 'Monthly'
        group by
            ...
            key coalesce(
                ...
                ROUND(
                    COALESCE(
                        ...
                        )-Credits.balance, Credits.cloudCreditsForPhase - Credits.balance
                    ), 2
                ...
                AVG(
                    Measures.Measures_measure_cost
                ) over(
                    partition by Credits.toParent.globalAccountId order by Credits.yearMonth rows between 2 preceding and current row
                )                                          as Measures_cost_SMA3        : Decimal(20, 2),
                AVG(
                    Measures.Measures_measure_cost
                ) over(
                    partition by Credits.toParent.globalAccountId order by Credits.yearMonth rows between 5 preceding and current row
                )                                          as Measures_cost_SMA6        : Decimal(20, 2),
                AVG(
                    Measures.Measures_measure_cost
                ) over(
                    partition by Credits.toParent.globalAccountId order by Credits.yearMonth rows between 11 preceding and current row
                )                                          as Measures_cost_SMA12       : Decimal(20, 2)
